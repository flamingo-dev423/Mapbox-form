...
export default function VerificationFormEmailJSCloudinary({ onSubmitSuccess }) {
  ...
  const uploadToCloudinary = async (file) => {
    const cloudName = import.meta.env.REACT_APP_CLOUDINARY_CLOUD_NAME || "dukff0sgz"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const serviceId = import.meta.env.REACT_APP_EMAILJS_SERVICE_ID || "service_20pxmvh"
      const templateId = import.meta.env.REACT_APP_EMAILJS_TEMPLATE_ID || "template_ybp7fv7"
      const publicKey = import.meta.env.REACT_APP_EMAILJS_PUBLIC_KEY || "j1tXyuVTAlgA49A8L"
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/images/image-4.jpeg')",
